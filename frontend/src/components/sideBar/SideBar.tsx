...
function SideBar() {
  ...
  return (
    <div className={`w-11/12 md:w-3/12 relative md:border-r-2 p-4 ${conversation ? 'hidden md:flex' : 'flex pl-6 md:pl-0'} flex-col gap-4 z-10 ${design?.thema ?  `md:border-[#31402f]` : `md:border-[#658261]`}`}>
